...
def get_args():
    ...
    parser.add_argument('video_dir', nargs='?', default='video', 
                        help='Path to the downloaded videos')
    parser.add_argument('-o', '--out_dir', default='frames',
...
def main(video_dir, out_dir, num_workers,
    ...
    if video_file.endswith('.mp4'):
        ...
        print("The video should be in mp4 format.")
